...
const Disclaimer: React.FC = () => {
  return (
    <>
      ...
      <section className="disclaimer-section my-5">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 disclaimer-box p-4 rounded-3 shadow">
              ...
              <p>
                ...
                such information to us, to our satisfaction, that the
