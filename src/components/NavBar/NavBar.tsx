				...
				<nav id="navmenu" className="navmenu">
					<ul>
						...
						<ul className='mobile-megamenu'>
							...
							<li className="dropdown"><a href="#"><span>Enterprise Software</span> <i className="bi bi-chevron-down toggle-dropdown"></i></a>
							<ul>
							...
							<li className="dropdown"><a href="#"><span>Development Tools</span> <i className="bi bi-chevron-down toggle-dropdown"></i></a>
							<ul>
							...
							<li className="dropdown"><a href="#"><span>Creative Suite</span> <i className="bi bi-chevron-down toggle-dropdown"></i></a>
							<ul>
                        ...
                        <span>Resources</span>
							...
							<div className="tab-content">
								...
								<div className="tab-pane fade show active" id="2190-tab-1" role="tabpanel" aria-labelledby="2190-tab-1-tab">
									...
									<div className="featured-banner">
										<div className="banner-content"> 
											<Image src={misc7} alt="Enterprise Solutions" className="banner-image" />
											<div className="banner-info">
											<h5>Enterprise Package</h5>
											<p>Comprehensive business management solution with advanced features and 24/7 support.</p>
											<a href="#" className="cta-btn">Get Started <i className="bi bi-arrow-right"></i></a>
											</div>
										</div>
									</div>
								</div>
								...
								<div className="tab-pane fade" id="2190-tab-2" role="tabpanel" aria-labelledby="2190-tab-2-tab">
									...
									<div className="featured-banner">
										<div className="banner-content">
												<Image src={misc12} alt="Development Tools" className="banner-image" />
												<div className="banner-info">
												<h5>Developer Suite</h5>
												<p>Complete toolkit for modern development teams with integrated CI/CD pipelines.</p>
												<a href="#" className="cta-btn">Explore Tools <i className="bi bi-arrow-right"></i></a>
											</div>
										</div>
									</div>
								</div>
								...
								<div className="tab-pane fade" id="2190-tab-3" role="tabpanel" aria-labelledby="2190-tab-3-tab">
									<div className="content-grid">
										...
										<div className="featured-banner">
											<div className="banner-content">
												<Image src={misc5} alt="Creative Suite" className="banner-image" />
												<div className="banner-info">
													<h5>Creative Pro</h5>
													<p>Everything you need for creative projects, from concept to final production.</p>
													<a href="#" className="cta-btn">Start Creating <i className="bi bi-arrow-right"></i></a>
												</div>
											</div>
										</div>
								</div>
									...
									<div className="resources-layout">
										<div className="resource-categories">
											<div className="resource-category">
												...
												<a href="#" className="resource-link">Browse Docs <i className="bi bi-arrow-right"></i></a>
												</div>
												<div className="resource-category">
												<i className="bi bi-play-circle"></i>
												<h5>Video Tutorials</h5>
												<p>Step-by-step video guides to help you get the most out of our solutions.</p>
												<a href="#" className="resource-link">Watch Tutorials <i className="bi bi-arrow-right"></i></a>
												</div>
												<div className="resource-category">
												<i className="bi bi-chat-square-dots"></i>
												<h5>Community Forum</h5>
												<p>Connect with other users, share tips, and get answers to your questions.</p>
												<a href="#" className="resource-link">Join Community <i className="bi bi-arrow-right"></i></a>
												</div>
												<div className="resource-category">
												<i className="bi bi-newspaper"></i>
												<h5>Blog &amp; Articles</h5>
												<p>Latest insights, best practices, and industry trends from our experts.</p>
												<a href="#" className="resource-link">Read Blog <i className="bi bi-arrow-right"></i></a>
											</div>
										</div>
									</div>
								</div>
